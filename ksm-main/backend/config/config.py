...
def get_env_config():
    ...
    if _ENV_MODE == 'docker':
        return {
            ...
            'CORS_ORIGINS': 'http://localhost:3002,http://localhost:3005,http://localhost:3006,http://localhost:8001,http://localhost:8002,http://localhost:8084,http://localhost:5001,https://report.ptkiansantang.com,https://devreport.ptkiansantang.com',
        ...
        return {
            ...
            'CORS_ORIGINS': 'http://localhost:3000,http://localhost:3004,http://localhost:3006,http://localhost:8000,http://localhost:8002,http://localhost:8084,http://localhost:5000',
