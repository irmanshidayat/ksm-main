...
from models.attendance_models import DailyTask, TaskAttachment, TaskComment, TaskSettings, AttendanceRecord
from models.knowledge_base import User
from models.role_management import Department, Role, UserRole
...
class DailyTaskService:
    ...
    def __init__(self):
        self.task_settings = self._get_task_settings()
