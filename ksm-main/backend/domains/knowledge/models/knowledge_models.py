...
Model untuk knowledge base, file management, dan user management
"""
...
# User model sudah dipindah ke domains/auth/models/auth_models.py
# Import User dari auth domain untuk backward compatibility
