...
from domains.knowledge.services.knowledge_base_service import KnowledgeBaseService
import logging
...
def get_categories():
    """Get semua kategori"""
    try:
        from domains.knowledge.models import KnowledgeCategory
...
def get_tags():
    """Get semua tags"""
    try:
        from domains.knowledge.models import KnowledgeTag
...
def get_files():
    ...
    try:
        from domains.knowledge.models import KnowledgeBaseFile
...
def debug_database_status():
    ...
    try:
        from domains.knowledge.models import KnowledgeBaseFile, KnowledgeCategory, KnowledgeTag
        from config.database import db
        from datetime import datetime
...
def create_sample_data():
    ...
    try:
        from domains.knowledge.models import KnowledgeCategory, KnowledgeTag, KnowledgeBaseFile
        from config.database import db
        import base64
